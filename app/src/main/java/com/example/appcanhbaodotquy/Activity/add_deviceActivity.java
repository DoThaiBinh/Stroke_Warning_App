...
public class add_deviceActivity extends AppCompatActivity {
    ImageView imgback;
    Button btnok;
    EditText ten, tuoi, idthietbi ,cao, nang, sodieu1ngay,cholesterol;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sodieu1ngay= findViewById(R.id.sodieu1ngay);
        cholesterol= findViewById(R.id.cholesterol);
        imgback.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent= new Intent(add_deviceActivity.this, homeActivity.class);
    ...
    private void addEvents(){
        ...
        x.setBmi(n/(c*c));
        //x.setBmi(2.3);
        api.apiService.ThemThietBi(x).enqueue(new Callback<String>() {
            @Override
            public void onResponse(Call<String> call, Response<String> response) {
                if (response.isSuccessful()){
                    ...
                    Toast.makeText(add_deviceActivity.this, "Không thể thêm thiết bị"+response.code(), Toast.LENGTH_SHORT).show();
            ...
            public void onFailure(Call<String> call, Throwable t) {
                Toast.makeText(add_deviceActivity.this, "Không có kết nối internet"+ t.getMessage(), Toast.LENGTH_SHORT).show();
